...
execute_process(
  COMMAND "/usr/bin/git" show-ref "3a8c001a38304d7bfebb9edf91df5be8e3deaa57"
  WORKING_DIRECTORY "/home/deniz/Documents/split-dev/build/gnuplot-iostream-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "3a8c001a38304d7bfebb9edf91df5be8e3deaa57")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("3a8c001a38304d7bfebb9edf91df5be8e3deaa57" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/3a8c001a38304d7bfebb9edf91df5be8e3deaa57")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/deniz/Documents/split-dev/build/gnuplot-iostream-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/deniz/Documents/split-dev/build/gnuplot-iostream-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
